...
$dur = "week";
$lines = 7*24;
$short = "avgspeed-anz-$dur";
$title = "Average ANZ Worker Speed ($dur)";
$pid = getmypid();
...
system("~mdriscoll/Bin/speed-anz.pl | tail -n$lines > $csvfile");
$pf = fopen($plotfile, "w");
$plotcmds = <<<EOT
    ...
    set grid
    plot "$csvfile" using 1:2 with lines lw 2 lt rgb "red"  title "SYM", \
                 '' using 1:3 with lines lw 2 lt rgb "blue" title "AKT"
EOT;
fwrite($pf, $plotcmds);
fclose($pf);

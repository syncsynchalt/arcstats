...
$lines = 30*24;
$short = "avgspeed-$dur";
$title = "Average Worker Speed ($dur)";
$pid = getmypid();
...
system("~mdriscoll/Bin/speed-averages.pl | tail -n$lines > $csvfile");
$pf = fopen($plotfile, "w");
$plotcmds = <<<EOT
    ...
    #set key off
    set grid
    plot "$csvfile" using 1:2 with lines lw 1 lt rgb "red"  title "EWL", \
                 '' using 1:3 with lines lw 1 lt rgb "blue" title "LVS"
EOT;
fwrite($pf, $plotcmds);
fclose($pf);
